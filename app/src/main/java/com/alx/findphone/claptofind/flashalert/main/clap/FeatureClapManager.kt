...
class FeatureClapManager(private val context: Context) {
    ...
    private var runnable = Runnable {
        VibrateFlashThread.Companion.isCancellable = true
        stopSound()
        VibrateFlashThread.Companion.stopAll()
    ...
    private fun playSoundSaveGson() {
        val statusPlay = AppPreferences.Companion.instance.hasSound
    ...
    fun flashSaveGson() {
        val statusFlash = AppPreferences.Companion.instance.hasFlash
...
//    }
    ...
    private fun vibrationSaveGson() {
        val statusFlash = AppPreferences.Companion.instance.hasVibrate
    ...
    fun playAll() {
        ...
        VibrateFlashThread.Companion.isCancellable = false
        vibrationSaveGson()
        flashSaveGson()
        playSoundSaveGson()
    }
