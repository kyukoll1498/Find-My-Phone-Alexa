...
import com.alx.findphone.claptofind.flashalert.base.ViewPagerAddFragmentsAdapter
import com.alx.findphone.claptofind.flashalert.databinding.ActivityOnboardingBinding
import com.alx.findphone.claptofind.flashalert.main.fragment.HomeFragment
import com.alx.findphone.claptofind.flashalert.main.fragment.OnBoardFragment
...
//                }
        ...
        binding.tvNext.setOnClickListener {
            ...
            when (binding.viewpagerOnboard.currentItem) {
                0 -> EventLogger.Companion.getInstance()?.logEvent("click_guide_1")
                1 -> EventLogger.Companion.getInstance()?.logEvent("click_guide_2")
                2 -> EventLogger.Companion.getInstance()?.logEvent("click_guide_3")
            }
        }
    }
