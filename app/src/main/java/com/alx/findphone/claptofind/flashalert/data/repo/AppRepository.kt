package com.alx.findphone.claptofind.flashalert.data.repo
...
object AppRepository {
    ...
    fun getAllSoundImport(): MutableList<SoundItem> {
        if (listAllSoundImport.isEmpty()) {
            RoomSoundDB.Companion.getDatabase()?.soundDao()?.getAllSound()
    ...
    fun insertSound(soundItem: SoundItem) {
        ...
        RoomSoundDB.Companion.getDatabase()?.soundDao()?.insert(soundItem)
    }
    ...
    fun updateName(path: String, newName: String) {
        ...
        RoomSoundDB.Companion.getDatabase()?.soundDao()?.updateName(path, newName)
    }
    ...
    fun deleteSound(path: String) {
        ...
        RoomSoundDB.Companion.getDatabase()?.soundDao()?.delete(path)
    }
}