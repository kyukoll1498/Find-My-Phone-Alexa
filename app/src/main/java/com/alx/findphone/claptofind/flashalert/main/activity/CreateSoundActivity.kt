...
import com.alx.findphone.claptofind.flashalert.REQUEST_FILE_AUDIO_CODE
import com.alx.findphone.claptofind.flashalert.REQUEST_MICRO_PERMISSION_CODE
import com.alx.findphone.claptofind.flashalert.REQUEST_READ_AUDIO_PERMISSION_CODE
import com.alx.findphone.claptofind.flashalert.REQUEST_READ_PERMISSION_CODE
...
import com.alx.findphone.claptofind.flashalert.databinding.ActivityCreateSoundBinding
import com.alx.findphone.claptofind.flashalert.main.dialog.ReadAudioPermissionDialog
...
class CreateSoundActivity : BaseActivity<ActivityCreateSoundBinding>(ActivityCreateSoundBinding::inflate) {
    ...
    override fun initView() {
        BroadcastUtils.registerReceiver(
            this, finishReceiver, IntentFilter(ACTION_FINISH_CREATE_SOUND_SCREEN)
        )
    }
            ...
            this, listNative, object : AdCallback() {
                override fun onNativeAds(nativeAd: NativeAd?) {
                    ...
                    AdmobManager.getInstance().showNative(
                        this@CreateSoundActivity, nativeAd, binding.frAd, AdmobManager.NativeAdType.BIG
                    )
