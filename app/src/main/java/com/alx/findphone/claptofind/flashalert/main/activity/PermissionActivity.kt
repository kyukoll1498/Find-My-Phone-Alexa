...
import com.alx.findphone.claptofind.flashalert.databinding.ActivityPermissionBinding
    ...
    private fun showNative() {
        AdCache.getInstance().ob6NativeHigh.observe(
            ...
            AdmobManager.getInstance().showNative(
                this@PermissionActivity, value, binding.frAd, AdmobManager.NativeAdType.BIG
            )
        }
