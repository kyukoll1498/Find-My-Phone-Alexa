package com.alx.findphone.claptofind.flashalert.main.widget;
...
public class SwitchButton extends View implements Checkable {
    ...
    public void setColorSelected(String colorSelected) {
        ...
        checkedColor = Color.parseColor(colorSelected);
        invalidate();
    }
...
//        checkedColor = Color.parseColor("#2FB4FF");
...
//            paint.setColor(Color.RED);
    ...
    private void drawButton(Canvas canvas, float x, float y) {
        canvas.drawCircle(x, y, buttonRadius-5, buttonPaint);
...
//        canvas.drawCircle(x, y, buttonRadius, paint);
    ...
    private void drawButton1(Canvas canvas, float x, float y) {
        canvas.drawCircle(x, y, buttonRadius-1, buttonPaint);
