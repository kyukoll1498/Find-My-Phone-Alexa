    ...
    fun loadRemote() {
        ...
        config.fetchAndActivate().addOnCompleteListener { task ->
            ...
            if (task.isSuccessful) {
                ...
                _101_splash_n_banner_high = config.getBoolean("_101_splash_n_banner_high")
                _101_splash_n_banner = config.getBoolean("_101_splash_n_banner")
                _102_splash_n_inter_high = config.getBoolean("_102_splash_n_inter_high")
                _102_splash_n_inter = config.getBoolean("_102_splash_n_inter")
                ...
                _304_ob4_n_native_high_1 = config.getBoolean("_304_ob4_n_native_high_1")
                _304_ob4_n_native_high_2 = config.getBoolean("_304_ob4_n_native_high_2")
                ...
                _306_ob6_n_native_high = config.getBoolean("_306_ob6_n_native_high")
                _306_ob6_n_native = config.getBoolean("_306_ob6_n_native")
