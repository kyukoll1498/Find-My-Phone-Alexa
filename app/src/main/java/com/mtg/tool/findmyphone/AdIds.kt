...
object AdIds {
    fun updateIdAdsWithRemoteConfig() {
        ...
        native_sound_high =  if (RemoteConfigManager.instance!!._601_sound_o_native_high) BuildConfig.native_sound_high else ""
        native_effect =  if (RemoteConfigManager.instance!!._602_effect_o_native) BuildConfig.native_effect else ""
        native_effect_high =  if (RemoteConfigManager.instance!!._602_effect_o_native_high) BuildConfig.native_effect_high else ""
        native_add =  if (RemoteConfigManager.instance!!._701_add_o_native) BuildConfig.native_add else ""
        native_add_high =  if (RemoteConfigManager.instance!!._701_add_o_native_high) BuildConfig.native_add_high else ""
        native_tutorial =  if (RemoteConfigManager.instance!!._901_tutorial_o_native) BuildConfig.native_tutorial else ""
        native_tutorial_high =  if (RemoteConfigManager.instance!!._901_tutorial_o_native_high) BuildConfig.native_tutorial_high else ""
